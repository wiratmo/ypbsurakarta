...
@if(Auth::user()->role == 1)
<center>
  <h2>Halaman Contributor <small>Create Picture Category</small></h2>
</center>
  <form method="POST" action="{{url('contributor/picturecategory/baru')}}" >
@elseif(Auth::user()->role == 2)
<center>
	<h2>Halaman Admin <small>Create Picture Category</small></h2>
</center>
  <form method="POST" action="{{url('admin/picturecategory/baru')}}" >
@endif
          {{ csrf_field() }}
